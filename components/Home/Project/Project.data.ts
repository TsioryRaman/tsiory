...
export const ProjectData: ProjectCardProps[] = [
  ...
  },
  {
    ...
    description:
      "Une application de Streaming videos en cours d'evolution, Front-End integree a 80% pour le moment",
  },
  {
    title: "E-Buy",
    ...
    description:
      "Une application de vente en ligne en incluant le systeme de paiement Stripe.",
  },
  {
    title: "Task",
    ...
    description:
      "Une application de tache pour avoir un dashboard de sa realisation durant son travail avec un systeme de drag and drop",
  },
];
