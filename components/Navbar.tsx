    ...
    return (
        <React.Fragment>
            <Flex zIndex={"5"} justifyContent={"space-between"} alignItems="center" w="100%" position={"fixed"} px="12" top="4">
                <Box display="flex" justifyContent="center" alignItems="center" color="white" overflow="hidden" px="8" py="4" background="linear-gradient(19deg, #21D4FD 0%, #B721FF 100%)"
                 borderRadius="30% 70% 70% 30% / 30% 30% 70% 70%"
                 boxShadow="15px 15px 50px rgba(0,0,0,0.2)"
                 animation={`${morphing} 10s infinite`}>
                    <Heading fontSize="4em" fontFamily="Sans-serif">T</Heading>
                </Box>
                <Flex direction={"row"}>
