        ...
        <Box borderRadius={3} height="100%" shadow='md' borderColor={border} borderWidth='1px' {...rest}>
            <Flex height="100%" flexDirection="column" p={4}>
                ...
                {img && <Box mt="auto" marginLeft={["-6", "-8", "-16", "-16"]}>
                    ...
                    <Image transform="scaleX(-1)" src={"/img/" + img} cursor="pointer" zIndex="2" alt={img} height={["300px", "400px", "300px", "400px"]} width="100%" _hover={{ transform: "scale(-1.2,1.2)", zIndex: "1000" }} transitionDuration={".8s"} />
                </Box>}
            </Flex>
        </Box>
    )
